...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT(
    ...
    KC_LSFT,  KC_Z,    KC_X,    KC_C,     KC_V,   KC_B,  KC_N,   KC_M,   KC_COMM,   KC_DOT,   KC_SLSH, KC_UP,   LOG_OUT, \
    KC_LCTL,  KC_LALT, KC_LGUI, MO(_FN1), KC_SPC,        KC_SPC, KC_SPC, TO(_BASE), TO(_FN1), KC_LEFT, KC_DOWN, KC_RGHT
  ),
  ...
  [_FN1] = LAYOUT(
    ...
    ____,     ____,    ____,    KC_TRNS, ____,           ____,   ____,   KC_TRNS,   KC_TRNS,  ____,    ____,    ____
  ),
};
